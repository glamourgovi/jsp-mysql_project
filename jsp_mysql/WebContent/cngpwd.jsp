...
<center>
	<div class="d1">
	<table>
	   	<tr><td>Current Password :</td><td><input type="Password" name="p0" placeholder=""  required></td></tr>
		<tr><td>New Password :</td><td><input type="Password" name="p1" placeholder=""  required></td></tr>
		<tr><td>Confirm Password :</td><td><input type="Password" name="p2" placeholder=""  required></td></tr>
